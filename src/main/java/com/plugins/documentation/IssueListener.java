...
// IssueViewEvent не работает в jira 8.14
    /*@EventListener
    public void onIssueEvent (IssueViewEvent issueViewEvent) throws IOException {
        log.warn("Dobro pojalovat' na server hueta");
